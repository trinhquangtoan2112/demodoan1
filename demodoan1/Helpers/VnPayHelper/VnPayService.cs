...
namespace demodoan1.Helpers.VnPayHelper
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(HttpContext content, VnPaymentRequestModel model)
        {
            ...
            vnpay.AddRequestData("vnp_ReturnUrl", "http://localhost:3000/KetQuaGiaoDich");
            vnpay.AddRequestData("vnp_ExpireDate", tomorrow.ToString("yyyyMMddHHmmss"));
        ...
        public VnPayResponseModal PaymentExcute(IQueryCollection collections)
        {
            var vnpay = new VnPayLibrary();
