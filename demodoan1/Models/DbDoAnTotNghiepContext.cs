...
public partial class DbDoAnTotNghiepContext : DbContext
{
    ...
    public string connectingString = "server=localhost;user=root;password=#Quangtoan2112;database=dbDoAnTotNghiep;port=3306";
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseMySql(connectingString, Microsoft.EntityFrameworkCore.ServerVersion.AutoDetect(connectingString));
